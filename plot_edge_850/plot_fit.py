...
error_I_th_850 = [0.090, 0.10, 0.100, 0.050, 0.060, 0.070, 0.070, 0.080, 0.090, 0.070, 0.100, 0.100, 0.110, 0.130,
                  0.160]
...
f_exp = exp(x, i_0, t_0)
ax3.text(280, 14, r"$y=1.7 \mathrm{\,mA}  \cdot \exp (\frac{T}{157 \mathrm{\,K} })$", color='green')
ax3.plot(x, f_exp, 'g-')
plt.grid(True)
